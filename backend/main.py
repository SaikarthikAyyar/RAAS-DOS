...
from backend.api.role_permissions_api import router as role_permissions_router
...
from backend.api.execution_media_api import (
...
app.include_router(
    ...
    administrationPartnersApi

)

app.include_router(administration_roles_api)
